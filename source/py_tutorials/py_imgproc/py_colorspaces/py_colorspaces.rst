...
-----------------------------------
This is a common question found in `stackoverflow.com <https://stackoverflow.com/search?tab=relevance&q=%20How%20to%20find%20HSV%20values%20to%20track%3f>`_. It is very simple and you can use the same function, `cv2.cvtColor()`. Instead of passing an image, you just pass the BGR values you want. For example, to find the HSV value of Green, try following commands in Python terminal:
::
